...
import integrationsOuraRouter from "./integrations-oura";
import integrationsWhoopRouter from "./integrations-whoop";
import integrationsGarminRouter from "./integrations-garmin";
...
router.use(integrationsOuraRouter);
router.use(integrationsWhoopRouter);
router.use(integrationsGarminRouter);
